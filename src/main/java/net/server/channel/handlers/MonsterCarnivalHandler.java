                ...
                try {
                    ...
                    if (tab == 0) {
                        ...
                        if (num >= mobs.size() || c.getPlayer().getCP() < mobs.get(num).right) {
                            c.announce(CFieldMonsterCarnival.CPQMessage((byte) 1));
                        ...
                        if (mcpq != null) {
                            if (!mcpq.canSummonR() && c.getPlayer().getTeam() == 0 || !mcpq.canSummonB() && c.getPlayer().getTeam() == 1) {
                                c.announce(CFieldMonsterCarnival.CPQMessage((byte) 2));
                                c.announce(CWvsContext.enableActions());
                                return;
                            }
                        ...
                        if (mcpq != null) {
                            ...
                            if (success != 1) {
                                switch (success) {
                                    case -1:
                                        c.announce(CFieldMonsterCarnival.CPQMessage((byte) 3));
                                        break;

                                    case 0:
                                        c.announce(CFieldMonsterCarnival.CPQMessage((byte) 4));
                                        break;
