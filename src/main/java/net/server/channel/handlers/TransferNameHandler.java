...
public final class TransferNameHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (!YamlConfig.config.server.ALLOW_CASHSHOP_NAME_CHANGE) {
            c.announce(CCashShop.sendNameTransferRules(4));
            return;
        }
        ...
        if (chr.getLevel() < 10) {
            ...
            c.announce(CCashShop.sendNameTransferRules(2));
            return;
        }
        //sql queries
        ...
        c.announce(CCashShop.sendNameTransferRules(0));
    }
}